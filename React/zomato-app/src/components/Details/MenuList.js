    ...
    return menuData.map((item) =>{
        ...
        <div key={item.menu_id}>
            ...
            <div className='col-md-4'>
                ...
                <spn className="glyphicon glyphicon-plus" onClick={() => {this.placeOrder(item.menu_id); }}></spn>
                </button>
                <button className='btn btn-danger'>
                <spn className="glyphicon glyphicon-minus" onClick={() => {this.removeOrder(item.menu_id);}}></spn>
                </button>
            </div>
